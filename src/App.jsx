  ...
  return (
    <div className="wrapper">
      <div>
        ...
        <Header isAuthorized={true} userData={props.state.userData}/>

        <div className="body__main">
          <Routes>
            <Route path="/" element={<Main/>}/>
            <Route path="/nav_mobile/*"
                   element={<NavMobile userData={props.state.userData}/>}/>
            <Route path="/account/*" element={<Lk state={props.state.lkPage} userData={props.state.userData}/>}/>
